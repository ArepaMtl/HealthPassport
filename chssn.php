  ...
  ga('send', 'pageview');
	...
	<body>
	 ...
	 <ul id="menuchssn">
			...
			<li class="item"><a href="chssn.php" class='chssn-title-bar'><div class='item-text submenu-text'><div id='chssn-title'></div><div><div class='lng-en'>Vision</br>Gasp&eacute;-Perc&eacute;</div><div class='lng-fr'>Vision</br>Gasp&eacute;-Perc&eacute;</div></div></div> <div class="below-button noclick"> </div></a><div class="info-items">
				<div class="dynamic-size-box">
					
				<div class='lng-en'>
					Vision Gasp&eacute;-Perc&eacute; Now is a non-profit organization founded in 2004. 
					It continues to work with and on behalf of the English-speaking community 
					from Manche d'&Eacute;p&eacute;e to Corner of the Beach. 
					Vision has become an invaluable resource and the voice of our community.<br/><br/>
				...
				<div class='lng-fr'>
				Vision Gasp&#xE9;-Perc&#xE9; Now est un organisme a&#x300; but non lucratif 
				fonde&#x301; en 2004. Vision travaille avec et pour la communaute&#x301; 
				anglophone entre Manche d&#x2019;E&#x301;pe&#x301;e et Coin du Banc. 
				Vision est la ressource de re&#x301;fe&#x301;rence pour notre communaute&#x301;.
