  ...
  ga('send', 'pageview');
	...
	<body>
	 ...
	 <ul id="menuchssn">
			...
			<li class="item"><a href="chssn.php" class='chssn-title-bar'><div class='item-text submenu-text'><div id='chssn-title'></div><div>The Megantic English-speaking Community </br>Development Corporation</div></div> <div class="below-button noclick"> </div></a><div class="info-items">
				<div class="dynamic-size-box">
					...
					<b>MCDC's Contact Information</b><br/><br/>
					
					<a href='http://www.mcdc.info/' class="health-pass-link">www.mcdc.info</a><br/><br/>
					<a href='mailto:mcdc@bellnet.ca' class="health-pass-link">mcdc@bellnet.ca</a><br/><br/>
					<b>Phone:</b> <a href='tel:+14183323851' class="health-pass-link">418 332-3851</a><br/><br/>
					<b>Address:</b> 906 Mooney Street West Thetford Mines (QC) G6G 6H2
