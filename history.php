...
<html manifest="cache.manifest">
  ...
  ga('send', 'pageview');
	...
	<ul id="menuyourhistory">
		<li class="item"><a href="personal_information.php">  <div class="loader personalinfo_loader" id="loader-personal">  </div><div class='item-text submenu-text'><div>Personal information</div><div>Informations personnelles</div></div> <div class="below-button noclick"> </div></a><div class="history-items" id="loader-personal-container"><?php getHistoryItems("personal_information.php"); ?></div></li>
