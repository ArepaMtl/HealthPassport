...
<html>
	...
	<ul id="menuyourhistory">
		...
		<li class="item"><a href="surgical.php"> <div class="loader surgical_loader" id="loader-surgical">  </div><div class='item-text submenu-text'><div>Surgical</div><div>Chirurgier</div></div> <div class="below-button noclick"> </div></a><div class="history-items" id="loader-surgical-container"><?php getHistoryItems("surgical.php"); ?></div></li>
